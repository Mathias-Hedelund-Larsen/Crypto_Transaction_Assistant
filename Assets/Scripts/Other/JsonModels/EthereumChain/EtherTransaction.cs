...
namespace EthereumChain
{
    ...
    public sealed class EtherTransaction : IEtherScanTransaction
    {
        ...
        [JsonProperty]
        private readonly string isError;

        [JsonProperty]
        private readonly string txreceipt_status;
        ...
        public string Txreceipt_status => txreceipt_status;
        ...
        public string TokenName => "Ether";

        public string TokenSymbol => "Eth";
    }
}